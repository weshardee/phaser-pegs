...
const EMPTY = 0;
const GAME_SIZE = 500;
const MIDDLE = GAME_SIZE / 2;
const TILE_SIZE = 65;
const NUM_PEG_TYPES = 5;
...
class GameState extends Phaser.State {
    ...
    addPeg({ x, y }) {
        const peg = this.game.add.sprite(x, y, 'pegs', Math.floor(Math.random() * NUM_PEG_TYPES), this.pegs);
        peg.anchor.x = 0.5;
        peg.anchor.y = 0.8;

        //  Input Enable the sprite
        peg.inputEnabled = true;
        peg.events.onInputDown.add(this.startMove, this);
    }

    getPosition(gridX, gridY) {
        const rowIsOdd = gridY % 2 === 1;
